...
include::includes/serverless-functions-secrets-configmaps-interactively.adoc[leveloffset=+1]
include::includes/serverless-functions-secrets-configmaps-interactively-specialized.adoc[leveloffset=+1]
...
include::includes/serverless-functions-mounting-secret-as-volume.adoc[leveloffset=+2]
include::includes/serverless-functions-mounting-configmap-as-volume.adoc[leveloffset=+2]
include::includes/serverless-functions-key-value-in-secret-to-env-variable.adoc[leveloffset=+2]
include::includes/serverless-functions-key-value-in-configmap-to-env-variable.adoc[leveloffset=+2]
include::includes/serverless-functions-all-values-in-secret-to-env-variables.adoc[leveloffset=+2]
include::includes/serverless-functions-all-values-in-configmap-to-env-variables.adoc[leveloffset=+2]
