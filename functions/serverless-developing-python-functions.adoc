...
After you have xref:serverless-create-func-kn_serverless-functions-getting-started[created a Python function project], you can modify the template files provided to add business logic to your function. This includes configuring function invocation and the returned headers and status codes.
...
include::includes/serverless-python-template.adoc[leveloffset=+1]
include::includes/serverless-invoking-python-functions.adoc[leveloffset=+1]
include::includes/serverless-python-function-return-values.adoc[leveloffset=+1]
include::includes/serverless-testing-python-functions.adoc[leveloffset=+1]
