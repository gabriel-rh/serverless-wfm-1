...
* xref:serverless-developing-nodejs-functions[Node.js]
* xref:serverless-developing-quarkus-functions[Quarkus]
* xref:serverless-developing-typescript-functions[TypeScript]
//* SpringBoot - TBC

include::includes/serverless-nodejs-context-object-reference.adoc[leveloffset=+1]
include::includes/serverless-typescript-context-object-reference.adoc[leveloffset=+1]
