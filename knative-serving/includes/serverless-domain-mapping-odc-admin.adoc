...
include::./serverless-domain-mapping.adoc[]


If you have cluster administrator permissions on {ocp-product-title} (or cluster or dedicated administrator permissions on {dedicated-product-title} or {rosa-product-title}), you can create a `DomainMapping` custom resource (CR) by using the *Administrator* perspective in the web console.
