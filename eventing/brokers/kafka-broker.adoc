...
include::../includes/serverless-about-kafka-broker.adoc[]
...
include::../includes/serverless-kafka-broker.adoc[leveloffset=+2]
include::../includes/serverless-kafka-broker-with-kafka-topic.adoc[leveloffset=+2]
include::../includes/serverless-kafka-broker-with-isolated-dataplane.adoc[leveloffset=+2]
include::../includes/serverless-create-kafka-namespaced-broker.adoc[leveloffset=+2]

// kafka broker general configmap
include::../includes/serverless-kafka-broker-configmap.adoc[leveloffset=+1]
...
include::../includes/serverless-kafka-broker-tls-default-config.adoc[leveloffset=+2]
include::../includes/serverless-kafka-broker-sasl-default-config.adoc[leveloffset=+2]
