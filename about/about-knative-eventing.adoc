...
include::includes/serverless-kafka-developer.adoc[leveloffset=+1]

[id="additional-resources_about-knative-eventing"]
[role="_additional-resources"]
== Additional resources
* link:https://access.redhat.com/documentation/en-us/red_hat_openshift_serverless/1.29/html-single/installing_serverless/#serverless-install-kafka-odc_installing-knative-eventing[Installing the `KnativeKafka` custom resource].
...
* link:https://access.redhat.com/documentation/en-us/red_hat_openshift_serverless/1.29/html-single/eventing/#serverless-event-delivery[Event delivery]
